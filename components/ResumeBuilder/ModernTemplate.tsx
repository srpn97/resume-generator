...
export const ModernTemplate: React.FC<ModernTemplateProps> = ({
    ...
    const renderSection = (title: string, children: React.ReactNode, sectionKey: string) => (
        <section
            className="resume-section clearfix cursor-pointer transition-colors hover:bg-gray-100/70 rounded-sm p-1 -m-1"
    ...
    const renderPersonalInfo = (children: React.ReactNode) => (
        <section
            className="cursor-pointer transition-colors hover:bg-gray-100/70 rounded-sm p-1 -m-1"
